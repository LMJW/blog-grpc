...
class EncodeServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetEncode = channel.unary_unary(
        ...
        request_serializer=test__pb2.plaintext.SerializeToString,
        response_deserializer=test__pb2.encodetext.FromString,
        )
...
def add_EncodeServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetEncode': grpc.unary_unary_rpc_method_handler(
          servicer.GetEncode,
          request_deserializer=test__pb2.plaintext.FromString,
          response_serializer=test__pb2.encodetext.SerializeToString,
      ),
  }
